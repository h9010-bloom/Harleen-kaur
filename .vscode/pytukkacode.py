...
def add_item():
    ...
    for cat in menu:
        if cat.lower() == category_input.lower():
            category = cat
            break
    else:
    ...
    print(f"{item} added to {category} successfully!")
...
def delete_item():
    ...
    item_input = input("Enter item name to delete: ").strip()

    for category in list(menu.keys()):
        for item in list(menu[category].keys()):
            if item.lower() == item_input.lower():
                del menu[category][item]
                print(f"{item} deleted successfully!")

                if len(menu[category]) == 0:
                    del menu[category]
                    print(f"{category} category removed (empty).")
...
def update_item():
    ...
    item_input = input("Enter item name to update: ").strip()
